...
class CheckoutDialog(QDialog):
    ...
    def _show_sqb_confirm_overlay(self, amount, method):
        ...
        lbl_icon.setStyleSheet("font-size: 16.5px; font-weight: 900; color: #F97316; border: none; background: transparent;")
        ...
        btn_cancel.setStyleSheet("""
            QPushButton {
                ...
                border-radius: 10px; padding: 14px 8px; border: none; outline: none;
            }
