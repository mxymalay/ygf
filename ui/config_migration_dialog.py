...
FIELD_LABELS = {
    ...
    "printer_relay_enabled": "打印机中继启用",
    "printer_relay_port": "打印机中继端口",
    "printer_relay_queue_name": "打印机中继队列",
    "printer_relay_auto_print": "外卖自动打印",
    "printer_relay_mode": "中继工作模式",
    "printer_relay_mode_policy": "中继模式策略",
    "printer_relay_last_check_at": "中继最后检查时间",
    "printer_relay_last_identification": "中继最近识别结果",
    "printer_relay_categories": "外卖分类规则",
    "printer_relay_kitchen_copies": "制作联份数",
    "printer_relay_cust_copies": "存根联份数",
    "printer_relay_match_mode": "外卖匹配模式",
    "call_mode": "叫号模式",
